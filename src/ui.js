...
const WHATS_NEW = [
  { date: 'Jun 14, 2026', title: 'Interface Themes', items: [
    ['Ten ways to dress the world', 'A new <b>Interface Theme</b> picker in <b>⚙ Settings</b>: choose from <b>ten palettes</b> — five <b>Night</b> (dark) and five <b>Day</b> (light “scroll”) finishes — across the <b>Crimson</b>, <b>Azure</b>, <b>Gilded</b>, <b>Jade</b> and <b>Ink</b> color families. Rarity &amp; element colors automatically re-tune to the mode so everything stays readable.'],
    ['Night glow &amp; day paper', 'Fine-tune the look: Night themes run <b>Flat</b> or <b>Neon Glow</b>, and Day themes pick a paper tone — <b>Rice Paper</b> or <b>Porcelain</b>. Your choice is <b>saved with your game</b> (default <b>Crimson Night</b>).'],
  ] },
  { date: 'Jun 14, 2026', title: 'Daily &amp; Weekly Resets', items: [
    ['One clock for everything', 'The Arena’s <b>daily</b> and <b>weekly rank rewards</b> now reset on the <b>same schedule as Daily Quests &amp; Bounties</b>: the daily at <b>00:00</b> (your local midnight) and the weekly at the <b>start of each week</b> (<b>Monday 00:00</b>). Each reward card now spells out when its next claim opens.'],
  ] },
  { date: 'Jun 14, 2026', title: 'Myriad Gu Refining', items: [
    ...
    ['Refining Proficiency now levels up', 'Your <b>refining proficiency</b> is now a proper <b>level</b> (like Dao Comprehension) rather than a raw point count. The Refining page shows your <b>level</b> with a bar to the next one; every refine still feeds it, and higher tiers unlock at set levels — <b>Tier 3 at Lv.2</b>, <b>Tier 5 at Lv.5</b> — with a success bonus that climbs as you level (up to <b>+15%</b>). Existing progress carries over at the matching level.'],
  ] },
